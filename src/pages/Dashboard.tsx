...
const Dashboard = () => {
  ...
  if (loading) {
    return <div className="p-4 text-center text-[#170B3F]">Loading...</div>;
  }
  ...
  return (
    <div className="bg-[#ffffff] min-h-screen flex justify-center items-start py-6">
      ...
      <div className="bg-[#1c1c1c] w-[375px] rounded-3xl shadow-2xl overflow-hidden flex flex-col space-y-4 p-4">
        ...
        <div className="bg-gradient-to-r from-[#01E777]/50 via-[#01E777]/30 to-[#01E777]/50 rounded-xl p-4 shadow-md">
          <h2 className="text-xl font-semibold text-[#170B3F]">Hi Moks, {greeting}</h2>
        ...
        <div className="space-y-3">
          ...
          <div className="bg-[#2a2a2a] rounded-2xl p-4 flex items-center shadow hover:shadow-[#01E777]/50 transition-shadow duration-300">
            <BanknotesIcon className="w-8 h-8 text-[#6762FD]" />
            <div className="ml-3">
              <p className="text-[#6762FD] text-sm">Loans</p>
              <p className="text-[1.75rem] font-bold text-[#170B3F]">{totalLoanRemaining.toLocaleString()}</p>
            </div>
          </div>

          {/* SAVINGS */}
          <div className="bg-[#2a2a2a] rounded-2xl p-4 flex items-center shadow hover:shadow-[#01E777]/50 transition-shadow duration-300">
            <BuildingLibraryIcon className="w-8 h-8 text-[#6762FD]" />
            <div className="ml-3">
              <p className="text-[#6762FD] text-sm">Savings</p>
              <p className="text-[1.75rem] font-bold text-[#170B3F]">{totalSavingsBalance.toLocaleString()}</p>
            </div>
          </div>
          ...
          <div className="bg-[#2a2a2a] rounded-2xl p-4 shadow hover:shadow-[#01E777]/50 transition-shadow duration-300">
            <div className="flex items-center mb-2">
              <ReceiptPercentIcon className="w-8 h-8 text-[#6762FD]" />
              <p className="ml-3 text-[#6762FD] font-semibold">Expenses</p>
            </div>
            <p className="text-[1.75rem] font-bold text-[#170B3F]">{totalExpenses.toLocaleString()}</p>

            <div className="flex justify-between text-sm mt-2">
              <div>
                <p className="text-[#6762FD]">Week</p>
                <p className="text-[#170B3F]">{weeklyExpenses.toLocaleString()}</p>
              </div>
              <div>
                <p className="text-[#6762FD]">Month</p>
                <p className="text-[#170B3F]">{monthlyExpenses.toLocaleString()}</p>
              </div>
              <div>
                <p className="text-[#6762FD]">Year</p>
                <p className="text-[#170B3F]">{yearlyExpenses.toLocaleString()}</p>
              </div>
            </div>
          </div>
        </div>
