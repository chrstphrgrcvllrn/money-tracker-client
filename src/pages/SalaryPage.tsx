      ...
      {activeTab === "totals" ? (
        <div className="space-y-2">
          {totals.length === 0 ? (
            ...
            totals.map((item, idx) => (
              <div key={idx} className="flex justify-between items-center p-3 bg-[#2C2C2E] border border-gray-600 rounded-lg">
        ...
        displayedSalaries.map((entry) => {
          ...
          return (
            <div key={entry._id} className="mb-6 bg-[#2C2C2E] border border-gray-600 shadow rounded-xl p-4">
