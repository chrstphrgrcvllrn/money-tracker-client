    ...
    <div className="text-xs max-w-md mx-auto mt-8 px-6 pb-6 bg-[var(--bg-page)]">
      ...
      <Modal open={showForm} onClose={() => setShowForm(false)} title="Add Month">
        ...
        <div className="flex justify-end gap-2 pt-2">
          <button onClick={() => setShowForm(false)} className="px-3 py-1 text-[var(--text-secondary)]">
            Cancel
          </button>
          <button
      ...
      <Modal open={showBillModal} onClose={() => setShowBillModal(false)} title="Add Bill">
        ...
        <div className="flex justify-end gap-2 pt-2">
          <button onClick={() => setShowBillModal(false)} className="px-3 py-1 text-[var(--text-secondary)]">
            Cancel
          </button>
          <button
      ...
      <Modal open={showDuplicateModal} onClose={() => setShowDuplicateModal(false)} title="Duplicate Month">
        ...
        <div className="flex justify-end gap-2 pt-2">
          <button onClick={() => setShowDuplicateModal(false)} className="px-3 py-1 text-[var(--text-secondary)]">
            Cancel
          </button>
          <button
