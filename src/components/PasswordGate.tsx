      ...
      <div className="min-h-screen flex items-center justify-center px-6 bg-[var(--bg-page)]">
        <form onSubmit={handleSubmit} className="w-full max-w-sm space-y-4">
          ...
          <input
            ...
            className="w-full px-3 py-3 text-center tracking-[0.3em] border rounded-lg focus:border-[var(--accent)]/50 outline-none bg-[var(--bg-input)] text-[var(--text-primary)] border-[var(--border-strong)]"
          />
